		...
		<CarouselContext.Provider
			...
			<div className="relative w-full">
				<div
					...
					<div
						className={cn(
							'absolute right-0  z-[40] h-auto  w-[5%] overflow-hidden bg-gradient-to-l'
						)}></div>
					...
					<div
						...
						<div className="rounded-3xl">
							<div className="rounded-3xl text-black h-80 w-56 md:h-[30rem] md:w-96 overflow-hidden flex flex-col items-start justify-start relative z-10">
								<div className="relative z-40 px-4 sm:p-16 space-y-3 h-full flex flex-col justify-center items-center">
									<p className=" text-2xl sm:w-[80%] font-lato font-light text-left  mt-2">
										Just a flavour of the{' '}
										<span className=" mr-1 text-tertiary font-bold font-floodstd">
											impact
										</span>{' '}
										we’ve created over the years...
									</p>
									<ArrowIcon fill="#FFAB00" />
								</div>
							</div>
						</div>
		...
		<>
				...
				{open && (
					<div className="fixed inset-0 h-screen z-50 overflow-auto">
						...
						<motion.div
							...
							<motion.p
								layoutId={layout ? `des-${card.title}` : undefined}
			...
			<motion.button
				...
				<div className="relative z-40 p-4 sm:p-8">
					<motion.p
						layoutId={layout ? `title-${card.title}` : undefined}
						className="text-white text-lg md:text-3xl font-semibold  text-left  font-sans mt-2">
						{card.title}
					</motion.p>
					<motion.p
